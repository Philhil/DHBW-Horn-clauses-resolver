...
{
  "$end", "error", "$undefined", "VAR", "FUNC", "PRAEDIKAT", "ARROW",
  "UND", "KOMMA", "TRUE", "FALSE", "KLAMMERO", "KLAMMERC", "NEWLINE",
  "$accept", "term", "params", "atom", "body", "formel", "seq", YY_NULLPTR
};
#endif
...
{
      -3,     3,     9,   -13,     4,   -12,    16,     0,    12,    -5,
      12,    -3,   -13,   -13,     7,    11,     8,   -13,   -13,   -13,
     -13,   -13,     0,     0,   -13,    10,   -13,   -13
};
...
{
       0,     7,     0,     9,     0,    14,     0,     0,     0,     0,
       0,    16,     1,     2,     3,     5,     0,    13,    12,    11,
      10,    15,     0,     0,     8,     0,     6,     4
};
...
{
       1,    11,     1,    13,    14,    18,     2,    17,    19,    20,
       9,    10,    25,    26,     7,     8,    12,     1,    22,    23,
      24,     0,    27,     0,    21
};

static const yytype_int8 yycheck[] =
{
       5,    13,     5,     3,     4,    10,     9,     8,     9,    10,
       6,     7,    22,    23,    11,     6,     0,     5,    11,     8,
      12,    -1,    12,    -1,    11
};
...
{
       0,     5,     9,    17,    18,    19,    20,    11,     6,     6,
       7,    13,     0,     3,     4,    15,    16,    17,    10,    17,
      17,    20,    11,     8,    12,    16,    16,    12
};
...
#line 39 "grammar.y" /* yacc.c:1646  */
    {
			...
			char* _var = (char*) malloc(sizeof((yyvsp[0].text)));
			strcpy(_var, (yyvsp[0].text));
...
#line 58 "grammar.y" /* yacc.c:1646  */
    {
			term *_term = (term*) malloc(sizeof(term));
			_term->varorfunc = (yyvsp[-3].text);
			_term->isvar = false;
			_term->liste = (yyvsp[-1].lt);
			(yyval.t) = _term;
		}
